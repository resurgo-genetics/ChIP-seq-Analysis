## fullPipelineScriptnoHomerTKv04.R 
## Version 5.0 Wednesday, December 10th, 2014
## Created By: Nathan Cormier, Tyler Kolisnik, and Mark Bieda.

## DESCRIPTION:
# This is the program for the full pipeline but without Homer. It is not to be confused with the start from mapped reads pipeline. 
...
upstreamRange <- 5000 # maximum distance upstream of TSS to look for a peak
downstreamRange <- 2000 # maximum distance downstream of TSS to look for a peak

## GO options
GOpValueCutoff <- 0.05 # highest p value from the GO categories to include in the ouput file
...
genomeDirectory <- "/home/tylerk/CWF1/keplerBin/genomes/hg19" # The directory of your genome file, within the kepler bin. hg19=human genome 19, Change if using different species or assembly! See above example for more info.
...
titlePrefix <- "Test 1"  # The title prefix will be added to the title of the graph creates
