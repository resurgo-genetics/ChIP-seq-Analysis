## startFromMappedReads_noHomerTKv05.R
## Version 5.0 Thursday, December 11th, 2014.
## Created By: Tyler Kolisnik, Nathan Cormier and Mark Bieda.

## DESCRIPTION:
# This is a program to change run the full pipeline script starting from Mapped Reads and skips the more memory intensive steps.
